...
puts 4 < 9
#YOU DO: Explain.
# A conditional checking if 4 is less than 9
#This should print true
books = 3
puts 4 < books
# YOU DO: Explain.
#A conditional checking if 4 is greater than the books variable
#This should be false
friends = 6
siblings = 2
puts friends > siblings
# YOU DO: Explain.
#A conditional checking if the variable friends is greater than the variable siblings
#This should be true
attendees = 9
meals = 8
puts attendees != meals
# YOU DO: Explain.
#A conditional checking if the variable attendees is not equal to the variable meals
#This should be true
...
# ANSWER: true
# it evaluated to true since loves_to_play is set to true and age is less than 2 which also evaluates to true. Both values were true so it overall returned true
